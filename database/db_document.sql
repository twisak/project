...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2020 at 06:37 PM
...
('C006', 'a:1:{i:0;s:8:\"55555555\";}', '2020-10-24', '2020-10-31', 'P001', 'A001', 'PS001', '001', '6', '1000', '12', '2563', 'ศึกษาพัฒนามหาลัย', 'อว.000004', '0000-00-00', '007', '8', '6000', '001', '001', '001', 'sdfsdf', '2020-10-30', '2020-10-30', 'a:1:{i:0;s:10:\"2222222222\";}', 'a:1:{i:0;s:5:\"sdfsd\";}', 'ผู้ว่าจ้างยินยอมให้ผู้รับจ้าง', 'a:1:{i:0;s:5:\"sdfsd\";}', 'N;', 'N;', '2020-10-24');
...
CREATE TABLE `tb_debt` (
  ...
  `approve` varchar(20) NOT NULL COMMENT 'อนุมัติให้จ่าย',
  `disburse` varchar(20) NOT NULL COMMENT 'เบิกจ่าย',
  `payer` varchar(20) NOT NULL COMMENT 'ผู้จ่ายเงิน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('D001', '2020-10-24', '131312', 'P003', 'A003', 'PS001', '001', 'วค', NULL, 'L001', 'อว.123', '2020-10-24', 'บ้านบ้า', 'คนโง่', 'ที่บ้าน', 'บ้านพัก', '2020-10-24', '22:28', 'บ้านพัก', '2020-10-31', '22:28', 'ข้าพเจ้า', '12354', 'a:3:{i:0;s:24:\"ค่าอาหาร\";i:1;s:27:\"ค่าที่พัก\";i:2;s:30:\"ค่าเดิมทาง\";}', 'a:3:{i:0;s:3:\"100\";i:1;s:3:\"200\";i:2;s:4:\"3000\";}', '001', '001', '002');
...
CREATE TABLE `tb_lend` (
  ...
  `str_date` date DEFAULT NULL COMMENT 'วันที่เริ่มต้น',
  `project` longtext DEFAULT NULL COMMENT 'โครงการ',
  `person_id` varchar(11) DEFAULT NULL COMMENT 'รหัสบุคลากร',
...
('L001', '2020-10-24', 'fffffffffffffffff', 'PS001', '001', 'พัฒนาศักยภาพครูและบุคลากรทางการศึกษาด้านการศึกษาและพัฒนาเด็กที่มีความต้องการพิเศษในพื้นที่ชายแดนใต้', 'นศ', '2', '200', 'ค่าที่พัก', '5000', '2', '4', '5', '1000', '100', '100', '-', '-', '-', '-', '5', '4', '6', '4', '4', '6', '4', '4', '4', 'a:1:{i:0;s:10:\"2020-10-31\";}', 'a:1:{i:0;s:21:\"ใบสำคัญ\";}', 'a:1:{i:0;s:4:\"5000\";}', 'a:1:{i:0;s:3:\"800\";}', '2020-10-24');
...
('NB1002', '001', 'อว.000002', 'sdfghgfdsadfg', 'a:1:{i:0;s:5:\"dfhdf\";}', 'a:1:{i:0;s:1:\"2\";}', 'P001', 'A001', '1', 'ตายแล้ว', '2020-07-01', '2020-07-09', 'ที่ไหนก็ได้', 'แล้วแต่', 'เรื่องของ...', '2020-07-27', 'PS002');
...
CREATE TABLE `tb_note_command` (
  ...
  `stp_date` date NOT NULL COMMENT 'วันที่สิ้นสุด',
  `title_id` varchar(20) NOT NULL COMMENT 'รหัสเรื่อง',
  `that` varchar(20) NOT NULL COMMENT 'ที่',
  `project_id` varchar(20) NOT NULL COMMENT 'รหัสโครงการ',
  `activity_id` varchar(20) NOT NULL COMMENT 'รหัสกิจกรรม',
  `person_id` varchar(20) NOT NULL COMMENT 'รหัสบุคลากร',
...
INSERT INTO `tb_note_command` (`doc_id`, `date_current`, `str_date`, `stp_date`, `title_id`, `that`, `project_id`, `activity_id`, `person_id`, `travel`, `byusing`, `driver`, `budget_id`, `teacher_id`) VALUES
('NC001', '2020-09-07', '2020-09-07', '2020-09-10', '002', 'อว.000001', 'P001', 'A001', 'PS002', 'sddasdasdasds', 'sdas', 'mmmmmmmmmmmm', 'B002', '002'),
('NC002', '2020-09-07', '2020-09-07', '2020-09-11', '002', 'อว.000002', 'P001', 'A001', 'PS001', 'sddasdasdasds', 'รถยนต์จ้างเหมา', 'นายรุสลัม ดูมีแด', 'B002', '001');
...
CREATE TABLE `tb_note_record1` (
  ...
  `at` varchar(20) DEFAULT NULL COMMENT 'ที่',
...
('NR1001', 'PS001', 'P001', 'A001', 'ศึกษาพัฒนามหาลัยqqq', '12315', '2020-07-25', '001', 'B004', '2020', '24', '26', '2000', '001', '002'),
('NR1002', 'PS002', 'P001', 'A001', 'ศึกษาพัฒนามหาลัย', 'อว.000001', '2020-07-27', '007', '', '2020', '2', '2', '2000', '001', '002');
...
('NR2002', 'PS002', 'P001', 'A002', 'ศึกษาพัฒนามหาลัย', 'อว.000002', '2020-07-27', '006', '2020-07-27', '2020-07-29', '2020-07-31');
...
CREATE TABLE `tb_person` (
  ...
  `house_num` varchar(20) DEFAULT NULL COMMENT 'บ้านเลขที่',
...
('PS001', 'นาง', 'ฟาตีเมาะ', 'การี', '1234567891234', '001', '54633', NULL, NULL, NULL, '75', '950201', '978'),
('PS002', 'นาย', 'สมามะ', 'ดา', '1211111111111', '004', '85', NULL, NULL, NULL, '18', '270110', '206'),
('PS003', 'นางสาว', 'asdasd', 'asdas', '2222222222222', '001', '2', NULL, NULL, NULL, '17', '260111', '202');
...
CREATE TABLE `tb_project` (
  ...
  `principle` varchar(100) DEFAULT NULL COMMENT 'หลักการและเหตุผล',
  `budget` varchar(20) DEFAULT NULL COMMENT 'งบประมาณ',
  `recorder` varchar(20) NOT NULL COMMENT 'ผู้บันทึก'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_project` (`project_id`, `project_name`, `fiscal_year`, `principle`, `budget`, `recorder`) VALUES
('P001', 'โครงการพัฒนาครูและบุคลากรทางการศึกษาเพื่อลดความ1เหลื่อมล้ำจากผลกระทบเหตุการณ์ความไม่สงบในพื้นทีชายแดนใต้', '2020', 'เพื่อผลประโยชน์ของมหาวิยทลัย', '5000', 'PS002'),
('P002', 'โครงการ ยกระดับคุณภาพการเรียนรู้ด้านการอ่าน การเขียนและการคิดวิเคราะห์ของนักเรียนในระดับการศึกษาขั้นพื้นฐานในพื้นที่ชายแดนใต้', '2020', 'เพื่อผลประโยชน์ของมหาวิยทลัย', '3000', 'PS002'),
('P003', 'โครงการส่งเสริมและเผยแพร่ความจริงที่ถูกต้องเพื่อสนับสนุนการแก้ไขปัญหา', '2020', 'เพื่อผลประโยชน์ของมหาวิยทลัย', '1000', 'PS002'),
('P004', 'โครงการจัดตั้งสถาบันพัฒนาครูและบุคลากรทางการศึกษาชายแดนใต้ มหาวิทยาลัยราชภัฏยะลา', '2020', 'เพื่อผลประโยชน์ของมหาวิยทลัย', '4000', 'PS002'),
('P005', 'การบ้าน', '2563', 'เพื่อผลประโยชน์ของมหาวิยทลัย', 'ประเภทงบประมาณ1', 'PS001'),
('P006', '0', '2563', 'เพื่อผลประโยชน์ของมหาวิยทลัย', 'ประเภทงบประมาณ1', 'PS001'),
('P007', 'โครงการพัฒนาครูและบุคลากรทางการศึกษาเพื่อลดความเหลื่อมล้ำจากผลกระทบเหตุการณ์ความไม่สงบในพื้นทีชายแดนใต้', '2563', 'เพื่อผลประโยชน์ของมหาวิยทลัย', 'ประเภทงบประมาณ1', 'PS001'),
('P008', 'การบ้าน1', '2563', 'เพื่อผลประโยชน์ของมหาวิยทลัย', 'fff', 'PS003'),
('P009', 'การบ้าน', '2563', 'ddd', '2000', 'PS002'),
('P010', '454', '2563', '45', '54', 'PS002');
...
CREATE TABLE `tb_salary` (
  ...
  `activity_id` varchar(10) NOT NULL COMMENT 'รหัสกิจกรรม	',
  `person_id` varchar(20) DEFAULT NULL COMMENT 'รหัสบุคลากร',
  `period` varchar(20) NOT NULL COMMENT 'งวดล่ะ',
  `total_amount` varchar(20) NOT NULL COMMENT 'รวมเป็นเงินทั้งสิ้น',
...
('S003', NULL, NULL, NULL, '', 'PS001', '', '', '', '0000-00-00', '', 'a:1:{i:0;s:10:\"2020-11-05\";}', 'a:1:{i:0;s:5:\"01:10\";}', 'a:1:{i:0;s:5:\"01:10\";}', 'a:1:{i:0;s:15:\"ววววว\";}', 'a:1:{i:0;s:0:\"\";}', '2020-10-22'),
('S004', NULL, NULL, NULL, '', 'PS001', '', '', '', '0000-00-00', '', 'a:1:{i:0;s:10:\"2020-10-30\";}', 'a:1:{i:0;s:5:\"01:04\";}', 'a:1:{i:0;s:5:\"01:04\";}', 'a:1:{i:0;s:14:\"aAfsfSDFsdfsdf\";}', 'a:1:{i:0;s:0:\"\";}', '2020-10-22'),
('S005', NULL, NULL, NULL, '', 'PS002', '', '', '', '0000-00-00', '', 'a:2:{i:0;s:10:\"2020-10-22\";i:1;s:10:\"2020-10-24\";}', 'a:2:{i:0;s:5:\"02:22\";i:1;s:5:\"02:18\";}', 'a:2:{i:0;s:5:\"02:23\";i:1;s:5:\"02:19\";}', 'a:2:{i:0;s:5:\"sasas\";i:1;s:9:\"บ้า\";}', 'a:2:{i:0;s:0:\"\";i:1;s:0:\"\";}', '2020-10-22');

-- --------------------------------------------------------

--
-- Table structure for table `tb_strategic`
--
...
CREATE TABLE `tb_teacher` (
  `teacher_id` varchar(20) NOT NULL COMMENT 'รหัสอาจารย์',
  `prefix` varchar(100) NOT NULL COMMENT 'คำนำหน้า',
...
INSERT INTO `tb_teacher` (`teacher_id`, `prefix`, `t_firstname`, `t_lastname`, `position_id`) VALUES
('001', 'ศาสตราจารย์', 'ปนัดดา', 'เรืองสงค์', '004'),
('002', 'ศาสตราจารย์', 'ซอแล', 'เกปัน', '005');
