                                  ...
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <div class="text-right">
                                                <a href="input_doc_salary.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table text-center table-bordered">
                                        ...
                                        <?php
                                            ...
                                            $sql ="SELECT tb_salary.id , tb_salary.doc_id , tb_project.project_name , tb_person.prefix, tb_person.firtname, tb_person.lastname FROM tb_salary
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="show_doc_salary.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-info">รายละเอียด</button></a>
                                                </td>
                                                <td><a href="JavaScript:if(confirm('ยืนยันการลบ ?') == true){window.location='delete_salary.php?id=<?php echo $row["id"];?>';}" class="btn btn-danger">ลบ</a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }
