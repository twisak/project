                                  ...
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <div class="text-right">
                                                <a href="input_doc_contract.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table text-center table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="show_doc_contract.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-info">รายละเอียด</button></a>
                                                </td>
