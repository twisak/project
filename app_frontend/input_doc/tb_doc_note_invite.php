                                  ...
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <div class="text-right">
                                                <a href="input_doc_note_invite1.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <div class="text-right">
                                                <a href="input_doc_note_invite2.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <div class="text-right">
                                                <a href="input_doc_note_invite3.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
