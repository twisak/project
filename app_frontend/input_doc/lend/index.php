                                ...
                                <div class="table-responsive">
                                    <table class="table text-center table-bordered">
                                        ...
                                        <?php
                                            ...
                                            WHERE tb_lend.person_id = '".$person_id_session."' AND (tb_lend.doc_id LIKE '%".$strKeyword."%' or tb_person.prefix LIKE '%".$strKeyword."%' or tb_person.firtname LIKE '%".$strKeyword."%'or tb_person.lastname LIKE '%".$strKeyword."%'  ) ";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="JavaScript:if(confirm('ยืนยันการลบ ?') == true){window.location='../lend/delete.php?id=<?php echo $row["doc_id"];?>';}" class="btn btn-danger">ลบ</a></td>
                                            </tr>
                                            <?php
                                            $i++;
                                            }}
