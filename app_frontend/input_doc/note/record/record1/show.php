...
<?php     $doc_id = $_GET['id']; ?>
                    ...
                    <div class="col-md-7 align-self-center">
                        <a href="../record1/report.php?id=<?php echo $doc_id;?>" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <a href="../record1/edit.php?id=<?php echo $doc_id;?>" class="btn btn-warning btn-block">แก้ไขข้อมูลเอกสาร</a>
                                            </div>
                                        </div>
