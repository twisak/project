                                  ...
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-3 text-right">
                                            <div class="text-right">
                                                <a href="../record/record1/add.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  <div class="row col-md-12">
                                        ...
                                        <div class="col-md-3 text-right">
                                            <div class="text-right">
                                                <a href="../record/record2/add.php"><button type="button" class="btn btn-primary">กรอกเอกสารเพิ่ม</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
