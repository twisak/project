...
<body id="<?php //echo $body['name'];?>">
    ...
    <?php include '../invite3/report1.php'; ?>
    <ul class="right-menu">
        <li>
        ...
        <li>
            <a href="http://localhost/project_student/app_frontend/input_doc/note/invite/invite3/show.php?id=<?=$doc_id;?>" onclick="window.close();">
