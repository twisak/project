    ...
    <div id="main-wrapper">
                                    <?php
                                        ...
                                        $payer = $result_debt['payer'];
                                            ...
                                            $sqll ="SELECT * FROM tb_lend WHERE doc_id = '".$lend_num."'";
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $project;?>" name="project" class="form-control form-control-line">
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                              <label for=""><b>ชื่อกิจกรรม</b></label></label>
                                                <input type="text" value="<?php echo $activity;?>" name="activity" class="form-control form-control-line">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-line" name="vehicle_num" value="<?php echo $vehicle_num; ?>" onKeyUp="IsNumeric(this.value,this)">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><b>คันล่ะ/บาท</b></label>
                                                <input type="text" class="form-control form-control-line" name="vehicle_price" onKeyUp="IsNumeric(this.value,this)" value="<?php echo $vehicle_price; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
