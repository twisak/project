            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center">
                        <a href="report_note_invite2.php?id=<?php echo $id;?>" class="btn waves-effect waves-light btn btn-info pull-right hidden-sm-down">
...
$id = $_GET['id'];
                                            ...
                                            $sql ="SELECT * FROM tb_note_book2 WHERE id = '".$id."' ";
                                            $query = mysqli_query($conn,$sql);
                                            while($row = mysqli_fetch_array($query,MYSQLI_ASSOC))
                                            {
                                                $id = $row['id'];
                                            ...
                                            while($row2 = mysqli_fetch_array($query2,MYSQLI_ASSOC))
                                            {
                                             ...
                                             $sql3 ="SELECT * FROM tb_strategic WHERE strategic_id = '".$strategic_id."' ";
                                             $query3 = mysqli_query($conn,$sql3);
                                             while($row3 = mysqli_fetch_array($query3,MYSQLI_ASSOC))
                                             {
                                                 $strategic = $row3['strategic'];
                                             }
                                    ?>
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <div class="form-group">
                                                <label><h5><b><u>เอกสารเรียนเชิญเข้าร่วม</u></b></h5></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <a href="edit_form_doc_invite2.php?id=<?php echo $id;?>" class="btn btn-warning btn-block">แก้ไขข้อมูลเอกสาร</a>
                                            </div>
                                        </div>
