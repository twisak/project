            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">ข้อมูลประเภทงบประมาณ</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">ข้อมูลประเภทงบประมาณ</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ข้อมูลประเภทงบประมาณ</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table text-center table-bordered">
                                        ...
                                        <tr>
                                                ...
                                                <th class="text-center"><b>ชื่อประเภทงบประมาณ</b></th>
                                        ...
                                        <?php
                                            ...
                                            $sql_tb_budget ="SELECT * FROM tb_budget WHERE (budget LIKE '%".$strKeyword."%' ) ";
