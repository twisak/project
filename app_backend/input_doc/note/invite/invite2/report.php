...
<body id="<?php //echo $body['name'];?>">
    ...
    <?php include '../invite2/report1.php'; ?>
    <ul class="right-menu">
        <li>
        ...
        <li>
            <a href="http://localhost/project_student/app_backend/input_doc/note/invite/invite2/show.php?doc_id=<?=$doc_id?>" onclick="window.close();">
