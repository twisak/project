                ...
                <div class="row">
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <!-- Tab panes -->
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="../record2/add_action.php" method="post">
                                    <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                               <label><b>เริ่มปฏิบัติตามสัญญาจ้างเหมา เมื่อวันที่</b></label>&nbsp;<label class="text-danger"><b>*</b></label></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><b>ลาออกจากเจ้างหน้าที่โครงการ มีผลตั้งแต่วันท</b></label>&nbsp;<label class="text-danger"><b>*</b></label></label>
