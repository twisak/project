            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">ข้อมูลหลักการและเหตุผล</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">ข้อมูลหลัการและเหตุผล</li>
                        </ol>
                    </div>
...
<!--
                                ...
                                <div class="text-right">
                                    <a href="../project/form_project.php"><button type="button" class="btn btn-primary">เพิ่มหลักการและเหตุผล</button></a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table text-center">
                                        ...
                                        <tr>
                                                ...
                                                <th class="text-center">รหัสหลักการและเหตุผล</th>
                                                <th class="text-center">ชื่อหลักการและเหตุผล</th>
